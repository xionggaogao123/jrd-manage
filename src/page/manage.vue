        ...
        <el-row style="height: 100%;">
            <el-col :span="4" style="min-height: 100%; background-color: #324057;">
                <el-menu :default-active="defaultActive" style="min-height: 100%;" theme="dark" router>
                    <el-menu-item index="notice"><i class="el-icon-menu"></i>公告</el-menu-item>
                    <el-menu-item index="statistical"><i class="el-icon-menu"></i>数据统计</el-menu-item>
                    <el-submenu index="2">
                        <template slot="title"><i class="el-icon-document"></i>出借人信息登记中心</template>
                    ...
                    <el-submenu index="5">
                        ...
                        <el-menu-item index="trueList">推测平台真标列表</el-menu-item>
                        <el-menu-item index="falseList">推测平台假标列表</el-menu-item>
                        <el-menu-item index="companyList">担保公司列表</el-menu-item>
                    </el-submenu>
                    <el-submenu index="6">
                        <template slot="title"><i class="el-icon-setting"></i>证据中心</template>
                        <el-menu-item index="evidenceList">证据列表</el-menu-item>
                    </el-submenu>
                    <el-submenu index="7">
